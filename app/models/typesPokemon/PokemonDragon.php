...
class PokemonDragon extends Pokemon implements Combattant {
    use Soins;
    ...
    {
       parent::__construct($id, $nom, 'Dragon', $pointsdevie, $attaque, $defense, $img);
    }
    ...
    public function CapaciteSpeciale(Pokemon $adversaire): int {
        ...
        if ($adversaire->getType() === 'Dragon') {
            $degatsBase *= self::EFFICACE;
        }
        elseif ($adversaire->getType() === 'Acier') {
