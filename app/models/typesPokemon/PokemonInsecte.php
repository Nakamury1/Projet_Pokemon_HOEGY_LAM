...
class PokemonInsecte extends Pokemon implements Combattant {
    use Soins;
    ...
    {
       parent::__construct($id, $nom, 'Insecte', $pointsdevie, $attaque, $defense, $img);
    }
    ...
    public function CapaciteSpeciale(Pokemon $adversaire): int {
        ...
        if ($adversaire->getType() === 'Plante' || $adversaire->getType() === 'Ténèbres' || $adversaire->getType() === 'Psy') {
            $degatsBase *= self::EFFICACE;
        }
        elseif ($adversaire->getType() === 'Feu' || $adversaire->getType() === 'Vol' || $adversaire->getType() === 'Combat' || $adversaire->getType() === 'Spectre' || $adversaire->getType() === 'Poison' || $adversaire->getType() === 'Acier' || $adversaire->getType() === 'Fée') {
