...
class PokemonElectrik extends Pokemon implements Combattant {
    use Soins;
    ...
    {
       parent::__construct($id, $nom, 'Electrik', $pointsdevie, $attaque, $defense, $img);
    }
    ...
    public function CapaciteSpeciale(Pokemon $adversaire): int {
        ...
        elseif ($adversaire->getType() === 'Dragon' || $adversaire->getType() === 'Plante' || $adversaire->getType() === 'Electrik') {
