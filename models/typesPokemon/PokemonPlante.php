...
class PokemonPlante extends Pokemon implements Combattant {
    use Soins;
    ...
    {
       parent::__construct($id, $nom, 'Plante', $pointsdevie, $attaque, $defense, $img);
    }
    ...
    public function CapaciteSpeciale(Pokemon $adversaire): int {
        ...
        if ($adversaire->getType() === 'Eau' || $adversaire->getType() === 'Roche' || $adversaire->getType() === 'Sol') {
            $degatsBase *= self::EFFICACE;
        }
        elseif ($adversaire->getType() === 'Feu' || $adversaire->getType() === 'Vol' || $adversaire->getType() === 'Acier' || $adversaire->getType() === 'Plante' || $adversaire->getType() === 'Poison' || $adversaire->getType() === 'Dragon' || $adversaire->getType() === 'Insecte') {
